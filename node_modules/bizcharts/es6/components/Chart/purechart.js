...
var PureChart = function (_Component) {
  ...
  _createClass(PureChart, [{
    ...
    value: function componentDidMount() {
      ...
      var ro = new _resizeObserverPolyfill2.default((0, _lodash2.default)(function () {
        _this2.chart.forceFit();
      }, 300));
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.addElement = function (name, id, props, parentInfo, viewId) {
    return _this3.g2Processor.addElement(name, id, props, parentInfo, viewId);
  };

  this.updateElement = function (name, id, props, parentInfo, viewId) {
    _this3.g2Processor.updateElement(name, id, props, parentInfo, viewId);
  };

  this.deleteElement = function (name, id, parentInfo) {
    _this3.g2Processor.deleteElement(name, id, parentInfo);
  };
