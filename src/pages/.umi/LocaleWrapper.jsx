...
const localeInfo = {
  'en-US': {
    messages: {
      ...require('D:/workspace/ant_design_pro/my-project/src/locales/en-US.js').default,
    },
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: {
      ...require('D:/workspace/ant_design_pro/my-project/src/locales/pt-BR.js').default,
    },
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: {
      ...require('D:/workspace/ant_design_pro/my-project/src/locales/zh-CN.js').default,
    },
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: {
      ...require('D:/workspace/ant_design_pro/my-project/src/locales/zh-TW.js').default,
    },
    locale: 'zh-TW',
