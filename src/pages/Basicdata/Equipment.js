...
class CreateForm extends PureComponent {
  ...
  renderContent = () => {
    ...
    return [
      <FormItem key="number" labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="设备编码">
        {form.getFieldDecorator('number', {
          rules: [{ required: true, message: '请输入至少五个字符！', min: 5 }],
        })(<Input placeholder="请输入" />)}
      </FormItem>,
      <FormItem key="name" labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="设备名">
        {form.getFieldDecorator('name', {
          rules: [{ required: true, message: '请输入至少五个字符！', min: 5 }],
        })(<Input placeholder="请输入" />)}
      </FormItem>,
      <FormItem key="authorization" labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="授权标识符">
      ...
      <FormItem key="isAuthorized" label="是否授权" labelCol={{ span: 5 }} wrapperCol={{ span: 15 }}>
        {form.getFieldDecorator('isAuthorized')(
      ...
      <FormItem key="status" label="状态" labelCol={{ span: 5 }} wrapperCol={{ span: 15 }}>
...
class UpdateForm extends PureComponent {
  ...
  constructor(props) {
    ...
    this.state = {
      formVals: {
        ...
        authorization: props.values.authorization,
        remark: props.values.remark,
        status: props.values.status,
        isAuthorized: props.values.isAuthorized,
      },
    };
    this.formLayout = {
      labelCol: { span: 7 },
  ...
  renderContent = formVals => {
    ...
    return [
      ...
      <FormItem key="isAuthorized" label="是否授权" labelCol={{ span: 5 }} wrapperCol={{ span: 15 }}>
        {form.getFieldDecorator('isAuthorized',{
          initialValue: formVals.isAuthorized,
        })(
          <Select placeholder="请选择" style={{ width: '100%' }}>
            <Option value={0}>否</Option>
            <Option value={1}>是</Option>
