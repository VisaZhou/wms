...
import styles from './Measurement.less';
...
class CreateForm extends PureComponent {
  ...
  renderContent = () => {
    ...
    return [
      <FormItem key="name" labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="计量单位名称">
...
@connect(({ measurement, loading }) => ({
  measurement,
  loading: loading.models.measurement,
}))
@Form.create()
class TableList extends PureComponent {
  ...
  render() {
    ...
    return (
      <PageHeaderWrapper title="计量单位管理">
        <Card bordered={false}>
